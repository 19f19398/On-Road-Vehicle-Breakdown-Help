...
export default function MerchantsList({route, navigation}) {
  ...
  return (
    <View style={{flex: 1, backgroundColor: '#ffffff', padding: 15}}>
        {lists && lists.length == 0 && <Text style={{fontSize: 16, color: '#000000', textAlign: 'center'}}>There is no registered Merchants, try again later...</Text>}
      <FlatList
        data={lists}
